...
$(function () {
    ...
    // adiciona tag de input com a especialidade no html
    function addEspecializacao(titulo) {
        $('#listaEspecializacoes')
            .append('<input type="hidden" value="' + titulo + '" name="especialidades">');
    }

    // mostra na página um toast com a mensagem de especialidade repetidas
        ...
        .autocomplete({
            ...
            select: function (event, ui) {
                ...
                if (exists === false) {
                    ...
                    // adiciona especialização na página para envio ao controller
